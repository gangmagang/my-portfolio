...
컬러는 인플루언서를 따르되, 스타일은 유지하는 방향으로 설계했습니다."
      ...
      <SubHighlightSection
        smallTitle="구조는 정리하고"
        bigTitle="감성은 유지"
        topDescription="인플루언서별 퍼스널 컬러와 촬영 환경이 다르기 때문에 컬러는 강제하지 않고, 자연스럽게 흡수하는 방향으로 조정했습니다."
        bottomDescription="이미지의 컬러는 유지하면서도,간격과 대비를 조정해 시선이 제품으로 이어지도록 설계했습니다."
        image="/Photo_main.png"
      />
      <SubGallerySection
        images={["/Photo_main.png", "/Photo_main.png"]}
        title="다양한 색 위에서도 브랜드는 흔들리지 않도록 설계했습니다."
